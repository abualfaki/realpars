...
WITH source AS (
    ...
    {% if is_incremental() %}
        ...
        WHERE safe_cast(created_at AS timestamp) >= TIMESTAMP_SUB(
            ...
            -- Since the Data in circle_community_raw_datsets.post_comment_liked is 
...
deduped_clean_base_data as (
    ...
    OVER (
        ...
        -- Each record_id is already unique after perfomring test in on raw_cc_data.post_comment_liked
